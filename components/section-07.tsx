              ...
              >
                ...
                <div className="relative flex flex-col h-full rounded-br-[100px] py-5 px-6">
                  ...
                  <div className="mb-5">
                    ...
                    <a className="btn-sm w-full inline-flex items-center text-blue-50 bg-blue-500 hover:bg-blue-600 shadow-xs" href="#0">
                      Get Starter
                    </a>
                  </div>
                ...
                {/* Pricing table 2 */}
                <div className="relative flex flex-col h-full bg-linear-to-b from-blue-100 to-blue-50 rounded-br-[100px] py-5 px-6">
